        ...
        <div class="container">
            ...
            <section class="corpo">
                <div class="tabela">
                    ...
                    <a  class="btn btn-primary" href="<?= URL_PAGINAS ?>editar_componente.php?tabela=<?= $tabela  ?>&id=<?= $id ?>" role="button">Editar</a>
                    <a  class="btn btn-primary" href="<?= URL_PAGINAS ?>deletar.php?tabela=<?= $tabela    ?>&id=<?= $id ?>" role="button">DELETAR</a>
                    <a class="btn btn-primary"  href="<?= URL_PAGINAS ?>listar_componentes.php?tabela=<?= $tabela ?>" role="button">Listar</a>
